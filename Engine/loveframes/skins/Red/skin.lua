...
skin.name = "Red"
skin.author = "RamiLego4Game"
skin.version = "0.5"

local smallfont = love.graphics.newFont("Lib/Fonts/kenvector_future_thin.ttf",10)
local imagebuttonfont = love.graphics.newFont("Lib/Fonts/kenvector_future_thin.ttf",15)
local bigfont = love.graphics.newFont("Lib/Fonts/kenvector_future.ttf",10)
...
skin.controls.frame_quads = {}
skin.controls.frame_quads.Side = love.graphics.newQuad(0,35,5,1,100,100)
skin.controls.frame_quads.SideTop = love.graphics.newQuad(10,0,1,5,100,100)
skin.controls.frame_quads.Mid = love.graphics.newQuad(10,35,5,5,100,100)
skin.controls.frame_quads.MidTop = love.graphics.newQuad(10,10,5,5,100,100)
skin.controls.frame_quads.CorTop = love.graphics.newQuad(0,0,10,10,100,100)
skin.controls.frame_quads.CorBot = love.graphics.newQuad(0,90,10,10,100,100)
...
skin.controls.button_quads = {}
skin.controls.button_quads[1] = {}
skin.controls.button_quads[2] = {}
skin.controls.button_quads[3] = {}
skin.controls.button_quads[4] = {}
skin.controls.button_quads[1].Start = love.graphics.newQuad(0,0,6,49,190,49)
skin.controls.button_quads[2].Start = love.graphics.newQuad(0,0,6,45,190,45)
skin.controls.button_quads[3].Start = love.graphics.newQuad(0,0,6,45,190,45)
skin.controls.button_quads[4].Start = love.graphics.newQuad(0,0,6,49,190,49)
skin.controls.button_quads[1].Mid = love.graphics.newQuad(6,0,1,49,190,49)
skin.controls.button_quads[2].Mid = love.graphics.newQuad(6,0,1,45,190,45)
skin.controls.button_quads[3].Mid = love.graphics.newQuad(6,0,1,45,190,45)
skin.controls.button_quads[4].Mid = love.graphics.newQuad(6,0,1,49,190,49)
skin.controls.button_quads[1].End = love.graphics.newQuad(184,0,6,49,190,49)
skin.controls.button_quads[2].End = love.graphics.newQuad(184,0,6,45,190,45)
skin.controls.button_quads[3].End = love.graphics.newQuad(184,0,6,45,190,45)
skin.controls.button_quads[4].End = love.graphics.newQuad(184,0,6,49,190,49)
...
skin.controls.progressbar_text_font                 = bigfont
...
skin.controls.multichoicerow_body_hover_color       = {248, 127, 48, 255}
...
skin.controls.columnlistrow_body_selected_color     = {232, 106, 23, 255}
skin.controls.columnlistrow_body_hover_color        = {248, 127, 48, 255}
...
function skin.DrawFrame(object)
	...
	local image = skin.images["metalPanel.png"]
  
  love.graphics.setColor(255,255,255,255)
  --Body
  love.graphics.draw(image,skin.controls.frame_quads.MidTop,x+5,y+5,0,(width-10)/5,20/5)
  love.graphics.draw(image,skin.controls.frame_quads.Mid,x+5,y+25,0,(width-10)/5,(height-30)/5)
  --Corners
  love.graphics.draw(image,skin.controls.frame_quads.CorTop,x,y)
  love.graphics.draw(image,skin.controls.frame_quads.CorTop,x+width,y,0,-1,1)
  love.graphics.draw(image,skin.controls.frame_quads.CorBot,x,y+height-10)
  love.graphics.draw(image,skin.controls.frame_quads.CorBot,x+width,y+height-10,0,-1,1)
  --Sides
  love.graphics.draw(image,skin.controls.frame_quads.SideTop,x+10,y,0,width-20,1)
  love.graphics.draw(image,skin.controls.frame_quads.SideTop,x,y+10,math.rad(90),15,-1)
  love.graphics.draw(image,skin.controls.frame_quads.SideTop,x+width,y+10,math.rad(90),15,1)
  love.graphics.draw(image,skin.controls.frame_quads.Side,x,y+25,0,1,height-35)
  love.graphics.draw(image,skin.controls.frame_quads.Side,x+width,y+25,0,-1,height-35)
  love.graphics.draw(image,skin.controls.frame_quads.Side,x+10,y+height,math.rad(-90),1,width-20)
	...
	if icon then
		...
		love.graphics.setColor(255, 255, 255, 255)
		love.graphics.draw(icon, x + 8, y + 7)
		love.graphics.setColor(namecolor)
		love.graphics.print(name, x + iconwidth + 13, y + 7)
	else
		love.graphics.setColor(namecolor)
		love.graphics.print(name, x + 8, y + 7)
	end	
end
...
--[[function skin.DrawButton(object)
	...
	if not enabled or not clickable then
		local image = skin.images["button04.png"]
		-- button body
		love.graphics.setColor(255, 255, 255, 255)
    love.graphics.draw(image, skin.controls.button_quads[4].Start, x, y, 0, 1, height/49)
    love.graphics.draw(image, skin.controls.button_quads[4].Mid, x+6, y, 0, width-12, height/49)
		love.graphics.draw(image, skin.controls.button_quads[4].End, x+width-6, y, 0, 1, height/49)
		-- button text
		love.graphics.setFont(font)
	...
	if down then
    local image = skin.images["button03.png"]
		-- button body
		love.graphics.setColor(255, 255, 255, 255)
    love.graphics.draw(image, skin.controls.button_quads[3].Start, x, y, 0, 1, height/45)
    love.graphics.draw(image, skin.controls.button_quads[3].Mid, x+6, y, 0, width-12, height/45)
		love.graphics.draw(image, skin.controls.button_quads[3].End, x+width-6, y, 0, 1, height/45)
		-- button text
		love.graphics.setFont(font)
		love.graphics.setColor(textdowncolor)
		love.graphics.print(text, x + width/2 - twidth/2, y + height/2 - theight/2)
	elseif hover then
    local image = skin.images["button02.png"]
		-- button body
		love.graphics.setColor(255, 255, 255, 255)
    love.graphics.draw(image, skin.controls.button_quads[2].Start, x, y, 0, 1, height/45)
    love.graphics.draw(image, skin.controls.button_quads[2].Mid, x+6, y, 0, width-12, height/45)
		love.graphics.draw(image, skin.controls.button_quads[2].End, x+width-6, y, 0, 1, height/45)
		-- button text
		love.graphics.setFont(font)
		love.graphics.setColor(texthovercolor)
		love.graphics.print(text, x + width/2 - twidth/2, y + height/2 - theight/2)
	else
    local image = skin.images["button01.png"]
		-- button body
		love.graphics.setColor(255, 255, 255, 255)
    love.graphics.draw(image, skin.controls.button_quads[1].Start, x, y, 0, 1, height/49)
    love.graphics.draw(image, skin.controls.button_quads[1].Mid, x+6, y, 0, width-12, height/49)
		love.graphics.draw(image, skin.controls.button_quads[1].End, x+width-6, y, 0, 1, height/49)
		-- button text
		love.graphics.setFont(font)
...
function skin.DrawProgressBar(object)
  ...
  local barFill = { Start = skin.images["barHorizontal_left.png"], Mid = skin.images["barHorizontal_mid.png"], End = skin.images["barHorizontal_right.png"] }
  local barEmpty = { Start = skin.images["barHorizontal_shadow_left.png"], Mid = skin.images["barHorizontal_shadow_mid.png"], End = skin.images["barHorizontal_shadow_right.png"] }
  
  love.graphics.setColor(255,255,255,255)
  love.graphics.draw(barEmpty.Start, x, y, 0, 1, height/26)
  love.graphics.draw(barEmpty.Mid, x+6, y, 0, (width-12)/16, height/26)
  love.graphics.draw(barEmpty.End, x+width-6, y, 0, 1, height/26)
  
  if barwidth > 0 then love.graphics.draw(barFill.Start, x, y, 0, 1, height/26) end
  if barwidth > 6 then love.graphics.draw(barFill.Mid, x+6, y, 0, (barwidth-12)/16, height/26) end
  if barwidth > 12 then love.graphics.draw(barFill.End, x+barwidth-6, y, 0, 1, height/26) end
...
function skin.DrawSliderButton(object)
	...
	local width = object:GetWidth()
	local height = object:GetHeight()
  local x = object:GetX()+width/2
	local y = object:GetY()+height/2
	local hover = object:GetHover()
	local down = object.down
	local parent = object:GetParent()
  ...
  local image = skin.images["circle.png"]
  local scale = 0.4
	
	if not enabled then
		-- button body
		love.graphics.setColor(160, 160, 160, 255)
		love.graphics.draw(image, x, y, 0, scale, scale, 18,18)
		return
	end
...
function skin.DrawCheckBox(object)
  ...
  if checked then
    love.graphics.draw(skin.images["boxCheckmark.png"],x,y,0,width/38,height/36)
  else
    love.graphics.draw(skin.images["boxCross.png"],x,y,0,width/38,height/36)
	end
end
...
function skin.DrawCollapsibleCategory(object)
  ...
  if height >=30 then
    ...
    love.graphics.draw(image,skin.controls.frame_quads.MidTop,x+5,y+5,0,(width-10)/5,(height-10)/5)
  end
  --Corners
  love.graphics.draw(image,skin.controls.frame_quads.CorTop,x,y)
  love.graphics.draw(image,skin.controls.frame_quads.CorTop,x+width,y,0,-1,1)
  ...
  if height >=30 then
    ...
    love.graphics.draw(image,skin.controls.frame_quads.SideTop,x,y+10,math.rad(90),height-20,-1)
    love.graphics.draw(image,skin.controls.frame_quads.SideTop,x+width,y+10,math.rad(90),height-20,1)
  end
  love.graphics.draw(image,skin.controls.frame_quads.SideTop,x,y+10,math.rad(90),15/50,-1)
  love.graphics.draw(image,skin.controls.frame_quads.SideTop,x+width,y+10,math.rad(90),15/50,1)
    ...
    love.graphics.draw(image,skin.controls.frame_quads.Side,x+10,y+height,math.rad(-90),1,width-20)
		...
		icon:setFilter("nearest", "nearest")
		love.graphics.draw(icon, x + width - 21, y + 5)
    love.graphics.draw(image,skin.controls.frame_quads.CorTop,x,y+height,0,1,-1)
    love.graphics.draw(image,skin.controls.frame_quads.CorTop,x+width,y+height,0,-1,-1)
    love.graphics.draw(image,skin.controls.frame_quads.SideTop,x+10,y+height,0,width-20,-1)
	end
	
	love.graphics.setFont(font)
	love.graphics.setColor(textcolor)
	love.graphics.print(text, x + 8, y + 7)
end
