...
loveframes.config["ACTIVESKIN"] = "Red"
...
function loveframes.update(dt)
  ...
  elseif hoverobject and hoverobject.type == "textinput" and not loveframes.resizeobject and not _AndroidKeyboard then
    love.keyboard.setTextInput(true)
    _AndroidKeyboard = true
  elseif _AndroidKeyboard then
    love.keyboard.setTextInput(false)
    _AndroidKeyboard = nil
  end
